...
do
	...
	python3 bench2_dot_pandas.py results/temp/dot_cond1_block1.csv results/temp/dot_cond1_block10.csv results/temp/dot_cond1_block11.csv results/dot_cond_1.csv
    r=$(($r + 1))
