...
# Properties modified on calculator3
calculator4.ResultArrayName = 'porosity2'
calculator4.Function = '4e-1'
...
# get color transfer function/color map for 'frac_thikness'
porosity2LUT = GetColorTransferFunction('porosity2')

# get opacity transfer function/opacity map for 'frac_thikness'
porosity2PWF = GetOpacityTransferFunction('porosity2')

# get 2D transfer function for 'frac_thikness'
porosity2TF2D = GetTransferFunction2D('porosity2')
...
calculator5.ResultArrayName = 'col2'
calculator5.Function = 'porosity2*frac_thikness*concentration'

# show data in view
calculator5Display = Show(calculator5, renderView2, 'GeometryRepresentation')
...
# show color bar/color legend
calculator5Display.SetScalarBarVisibility(renderView2, True)
...
# Properties modified on calculator4
calculator5.ResultArrayName = 'col3'
