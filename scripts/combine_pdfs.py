...
def compile_latex_to_pdf(tex_file):
    ...
    try:
        ...
        print("pdflatex command not found. Make sure LaTeX is installed and added to your PATH.")
    ...
    for file_name in os.listdir(folder_path):
        if "crop" in file_name:
            ...
            if os.path.exists(legend_pdf):
                ...
                output_tex = os.path.join(folder_path, file_name.replace("crop", "combined").replace(".pdf", ".tex"))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Generate LaTeX scripts for plots and legends.')
